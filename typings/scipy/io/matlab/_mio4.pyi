...
class VarReader4:
    ...
    def array_from_header(self, hdr, process=...): # -> coo_array | NDArray[complex128] | ndarray[_AnyShape, dtype[Any]]:
        ...
    
    def read_sub_array(self, hdr, copy=...): # -> ndarray[_AnyShape, dtype[Any]]:
    ...
    def read_full_array(self, hdr): # -> NDArray[complex128] | ndarray[_AnyShape, dtype[Any]]:
    ...
    def read_char_array(self, hdr): # -> ndarray[_AnyShape, dtype[Any]]:
...
class MatFile4Reader(MatFileReader):
    ...
    def read_var_array(self, header, process=...): # -> coo_array | NDArray[complex128] | ndarray[_AnyShape, dtype[Any]]:
