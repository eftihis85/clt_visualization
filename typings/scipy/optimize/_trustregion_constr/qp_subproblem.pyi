...
def box_sphere_intersections(z, d, lb, ub, trust_radius, entire_line=..., extra_info=...): # -> tuple[Incomplete, Incomplete, bool, dict[str, Any], dict[str, Any]] | tuple[Incomplete, Incomplete, bool]:
