...
class VectorFunction:
    ...
    def jac(self, x): # -> float64 | int_ | numpy.bool[builtins.bool] | ndarray[tuple[int], dtype[float64 | int_ | numpy.bool[builtins.bool]]] | ndarray[tuple[int, int], dtype[float64 | int_ | numpy.bool[builtins.bool]]] | ndarray[_AnyShape, dtype[float64 | int_ | numpy.bool[builtins.bool]]] | csr_matrix | csr_array | <subclass of _csr_base* and sparray> | _csr_base | object | LinearOperator | _Array1D[float64] | _Array[tuple[int, int], float64] | ndarray[_AnyShape, dtype[float64]]:
        ...
