...
def build_quadratic_1d(J, g, s, diag=..., s0=...): # -> tuple[Any, Any, Any] | tuple[Any, Incomplete]:
...
def compute_jac_scale(J, scale_inv_old=...): # -> tuple[NDArray[float64] | Any, NDArray[float64] | Any | NDArray[Incomplete]]:
