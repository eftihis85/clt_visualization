...
@xp_capabilities(cpu_only=True, jax_jit=False, skip_backends=[("dask.array", "https://github.com/data-apis/array-api-extra/issues/488")])
class PPoly(_PPolyBase):
    ...
    def solve(self, y=..., discontinuity=..., extrapolate=...): # -> ndarray[tuple[()], dtype[Incomplete]]:
        """
    ...
    def roots(self, discontinuity=..., extrapolate=...): # -> ndarray[tuple[()], dtype[Incomplete]]:
        """
...
class NdPPoly:
    ...
    def integrate(self, ranges, extrapolate=...): # -> NDArray[Any] | NDArray[complex128 | float64] | ndarray[tuple[int], dtype[Any]] | Any:
        """
        Compute a definite integral over a piecewise polynomial.
