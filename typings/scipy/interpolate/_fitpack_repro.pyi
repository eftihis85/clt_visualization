...
def generate_knots(x, y, *, w=..., xb=..., xe=..., k=..., s=..., nest=..., bc_type=...): # -> Generator[Any | _Array1D[Incomplete], Any, None]:
...
class Fperiodic:
    ...
    """
    def __init__(self, x, y, t, k, s, w=..., *, R=..., Y=..., A1=..., A2=..., Z=...) -> None:
        ...
...
@xp_capabilities(cpu_only=True, jax_jit=False, allow_dask_compute=True)
def make_splrep(x, y, *, w=..., xb=..., xe=..., k=..., s=..., t=..., nest=..., bc_type=...): # -> BSpline:
...
@xp_capabilities(cpu_only=True, jax_jit=False, allow_dask_compute=True)
def make_splprep(x, *, w=..., u=..., ub=..., ue=..., k=..., s=..., t=..., nest=..., bc_type=...): # -> tuple[Any, Array | Any] | tuple[BSpline, Any]:
    r"""
