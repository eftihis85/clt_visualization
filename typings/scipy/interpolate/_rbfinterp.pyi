...
_NAME_TO_MIN_DEGREE = ...
extra_note = ...
@xp_capabilities(skip_backends=[("dask.array", "linalg.lu is broken; array_api_extra#488"), ("array_api_strict", "array-api#977, diag, view")], extra_note=extra_note)
class RBFInterpolator:
    ...
    def __getstate__(self): # -> tuple[tuple[Array | Any, Any, Array | Any, Any, int | Any | None, Any, str | Any, float | Any, ndarray[tuple[int, int], dtype[signedinteger[_64Bit]]] | NDArray[signedinteger[_64Bit]] | Any], tuple[Any, Any, Any] | tuple[KDTree | Any]]:
        ...
