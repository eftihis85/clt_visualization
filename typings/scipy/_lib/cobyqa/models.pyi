...
def build_system(interpolation): # -> tuple[Any, Any, Any] | tuple[_Array[tuple[int, int], float64], _Array1D[float64], tuple[Any, Any]]:
    """
...
class Models:
    ...
    def cub(self, x, mask=...): # -> NDArray[Incomplete]:
        """
    ...
    def cub_grad(self, x, mask=...): # -> ndarray[tuple[int, int], dtype[Incomplete]]:
        """
    ...
    def cub_hess(self, mask=...): # -> ndarray[tuple[int, int, int], dtype[Incomplete]]:
        """
    ...
    def cub_hess_prod(self, v, mask=...): # -> ndarray[tuple[int, int], dtype[Incomplete]]:
        """
    ...
    def cub_curv(self, v, mask=...): # -> NDArray[Incomplete]:
        """
    ...
    def ceq(self, x, mask=...): # -> NDArray[Incomplete]:
        """
    ...
    def ceq_grad(self, x, mask=...): # -> ndarray[tuple[int, int], dtype[Incomplete]]:
        """
        Evaluate the gradients of the quadratic models of the nonlinear
    ...
    def ceq_hess(self, mask=...): # -> ndarray[tuple[int, int, int], dtype[Incomplete]]:
        """
        Evaluate the Hessian matrices of the quadratic models of the nonlinear
        equality functions.
    ...
    def ceq_hess_prod(self, v, mask=...): # -> ndarray[tuple[int, int], dtype[Incomplete]]:
        """
        Evaluate the right product of the Hessian matrices of the quadratic
    ...
    def ceq_curv(self, v, mask=...): # -> NDArray[Incomplete]:
        """
        Evaluate the curvature of the quadratic models of the nonlinear
