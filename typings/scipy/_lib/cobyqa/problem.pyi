...
class NonlinearConstraints:
    ...
    def __call__(self, x): # -> tuple[NDArray[Incomplete], NDArray[Incomplete]] | tuple[NDArray[Any] | NDArray[Incomplete], NDArray[Any] | NDArray[Incomplete]]:
        """
...
class Problem:
    ...
    def __call__(self, x, penalty=...): # -> tuple[float, NDArray[Incomplete], NDArray[Incomplete]]:
        """
