...
__all__ = ["atleast_nd", "cov", "create_diagonal", "expand_dims", "isclose", "nan_to_num", "one_hot", "pad", "sinc"]
...
def nan_to_num(x: Array | float | complex, /, *, fill_value: int | float = ..., xp: ModuleType | None = ...) -> Array:
    """
...
def one_hot(x: Array, /, num_classes: int, *, dtype: DType | None = ..., axis: int = ..., xp: ModuleType | None = ...) -> Array:
    """
...
def partition(a: Array, kth: int, /, axis: int | None = ..., *, xp: ModuleType | None = ...) -> Array:
    """
...
def argpartition(a: Array, kth: int, /, axis: int | None = ..., *, xp: ModuleType | None = ...) -> Array:
    """
...
def isin(a: Array, b: Array, /, *, assume_unique: bool = ..., invert: bool = ..., kind: str | None = ..., xp: ModuleType | None = ...) -> Array:
    """
