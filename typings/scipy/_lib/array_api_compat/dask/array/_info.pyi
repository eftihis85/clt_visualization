...
class __array_namespace_info__:
    ...
    @overload
    def dtypes(self, /, *, device: Device | None = ..., kind: None = ...) -> DTypesAll:
        ...
    
    @overload
    def dtypes(self, /, *, device: Device | None = ..., kind: Literal["bool"]) -> DTypesBool:
        ...
    
    @overload
    def dtypes(self, /, *, device: Device | None = ..., kind: Literal["signed integer"]) -> DTypesSigned:
        ...
    
    @overload
    def dtypes(self, /, *, device: Device | None = ..., kind: Literal["unsigned integer"]) -> DTypesUnsigned:
        ...
    
    @overload
    def dtypes(self, /, *, device: Device | None = ..., kind: Literal["integral"]) -> DTypesIntegral:
        ...
    
    @overload
    def dtypes(self, /, *, device: Device | None = ..., kind: Literal["real floating"]) -> DTypesReal:
        ...
    
    @overload
    def dtypes(self, /, *, device: Device | None = ..., kind: Literal["complex floating"]) -> DTypesComplex:
        ...
    
    @overload
    def dtypes(self, /, *, device: Device | None = ..., kind: Literal["numeric"]) -> DTypesNumeric:
        ...
    
    def dtypes(self, /, *, device: Device | None = ..., kind: DTypeKind | None = ...) -> DTypesAny:
        """
