...
from typing import Any, Final, Literal, SupportsIndex, TYPE_CHECKING, TypeAlias, TypeGuard, overload
...
if TYPE_CHECKING:
    ...
    _ArrayApiObj: TypeAlias = (npt.NDArray[Any] | cp.ndarray | da.Array | jax.Array | ndx.Array | sparse.SparseArray | torch.Tensor | SupportsArrayNamespace[Any])
