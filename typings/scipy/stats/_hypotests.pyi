...
@xp_capabilities(skip_backends=[("dask.array", "lazy -> no _axis_nan_policy"), ("jax.numpy", "lazy -> no _axis_nan_policy")])
...
@xp_capabilities(cpu_only=True, skip_backends=[('dask.array', 'typical dask issues')], jax_jit=False)
...
@xp_capabilities(skip_backends=[('cupy', 'needs rankdata'), ('dask.array', 'needs rankdata')], cpu_only=True, jax_jit=False)
