...
def hdquantiles(data, prob=..., axis=..., var=...): # -> MaskedArray[tuple[int, int], dtype[float64]]:
    """
...
def hdquantiles_sd(data, prob=..., axis=...): # -> MaskedArray[tuple[int], dtype[float64]]:
    """
...
def mquantiles_cimj(data, prob=..., alpha=..., axis=...): # -> tuple[_MaskedArray[float64] | Any, _MaskedArray[float64] | Any]:
    """
