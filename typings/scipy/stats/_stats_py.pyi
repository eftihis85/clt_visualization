...
ModeResult = ...
@xp_capabilities(skip_backends=[('dask.array', "can't compute chunk size"), ('jax.numpy', "relies on _axis_nan_policy"), ('cupy', "data-apis/array-api-compat#312")])
...
_scale_conversions = ...
@xp_capabilities(skip_backends=[('dask.array', 'no quantile (take_along_axis)'), ('jax.numpy', 'lazy -> no _axis_nan_policy)')])
...
@xp_capabilities(skip_backends=[('jax.numpy', 'not supported by `quantile`'), ('dask.array', 'not supported by `quantile`')])
@_axis_nan_policy_factory(lambda x: x, result_to_tuple=lambda x, _: (x, ), n_outputs=1, default_axis=0)
...
@xp_capabilities(cpu_only=True, exceptions=["cupy", "jax.numpy"])
@_axis_nan_policy_factory(pack_TtestResult, default_axis=0, n_samples=2, result_to_tuple=unpack_TtestResult, n_outputs=6)
def ttest_ind(a, b, *, axis=..., equal_var=..., nan_policy=..., alternative=..., trim=..., method=...): # -> TtestResult:
    """
...
KstestResult = ...
@xp_capabilities(cpu_only=True, jax_jit=False, skip_backends=[('dask.array', 'needs take_along_axis')])
...
KruskalResult = ...
@xp_capabilities(skip_backends=[('cupy', 'no rankdata'), ('dask.array', 'no rankdata')], jax_jit=False)
...
BrunnerMunzelResult = ...
@xp_capabilities(cpu_only=True, skip_backends=[('dask.array', 'needs rankdata'), ('cupy', 'needs rankdata'), ('jax.numpy', 'needs _axis_nan_policy decorator')])
@_axis_nan_policy_factory(BrunnerMunzelResult, n_samples=2)
def brunnermunzel(x, y, alternative=..., distribution=..., nan_policy=..., *, axis=...): # -> BrunnerMunzelResult:
...
@xp_capabilities(skip_backends=[("cupy", "`repeat` can't handle array second arg"), ("dask.array", "no `take_along_axis`")], jax_jit=False)
...
@xp_capabilities(skip_backends=[('dask.array', "too many issues")], jax_jit=False, cpu_only=True, exceptions=('cupy', 'jax.numpy'))
...
def lmoment(sample, order=..., *, axis=..., sorted=..., standardize=...): # -> Any | Array:
