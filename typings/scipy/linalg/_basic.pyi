...
def solve(a, b, lower=..., overwrite_a=..., overwrite_b=..., check_finite=..., assume_a=..., transposed=...): # -> ndarray[_AnyShape, dtype[Any]] | ndarray[_AnyShape, dtype[float64]]:
    """
...
def solve0(a, b, lower=..., overwrite_a=..., overwrite_b=..., check_finite=..., assume_a=..., transposed=...):
    """
    Solve the equation ``a @ x = b`` for  ``x``,
    where `a` is a square matrix.
...
def solve_banded(l_and_u, ab, b, overwrite_ab=..., overwrite_b=..., check_finite=...): # -> NDArray[float64] | Any:
    """
...
@_apply_over_batch(('a', 2), ('b', '1|2'))
def solveh_banded(ab, b, overwrite_ab=..., overwrite_b=..., lower=..., check_finite=...): # -> NDArray[float64]:
    """
...
def det(a, overwrite_a=..., check_finite=...): # -> complex128 | float64 | _Array[tuple[()] | Any, float64 | complex128] | ndarray[_AnyShape, dtype[Any]] | _Array[tuple[()] | Any, Incomplete]:
    """
...
def pinv(a, *, atol=..., rtol=..., return_rank=..., check_finite=...): # -> tuple[Any, Any]:
    """
...
@_apply_over_batch(('A', 2))
def matrix_balance(A, permute=..., scale=..., separate=..., overwrite_a=...): # -> tuple[NDArray[float64], tuple[NDArray[float64], _Array1D[int_]]] | tuple[NDArray[float64], NDArray[float64]] | tuple[Any, tuple[NDArray[Any], Any]] | tuple[Any, ndarray[_AnyShape, dtype[Any]]]:
    """
