...
def hessenberg(a, calc_q=..., overwrite_a=..., check_finite=...): # -> ndarray[tuple[int, int] | Any, dtype[float64]] | tuple[ndarray[tuple[int, int] | Any, dtype[float64]], numpy._core.multiarray._Array[tuple[int, int] | Any, float64]] | tuple[numpy.lib._function_base_impl._Array[_AnyShape, float64] | Any | NDArray[Any], _Array2D[float64]] | numpy.lib._function_base_impl._Array[_AnyShape, float64] | NDArray[Any] | tuple[Any, Any]:
    """
