...
@xp_capabilities()
def triang(M, sym=..., *, xp=..., device=...): # -> Array | ndarray[_AnyShape, dtype[Any]]:
...
@xp_capabilities()
def parzen(M, sym=..., *, xp=..., device=...): # -> Array:
...
@xp_capabilities()
def bohman(M, sym=..., *, xp=..., device=...): # -> Array | ndarray[_AnyShape, dtype[Any]]:
...
@xp_capabilities()
def bartlett(M, sym=..., *, xp=..., device=...): # -> Array:
    r"""
...
@xp_capabilities()
def tukey(M, alpha=..., sym=..., *, xp=..., device=...): # -> Array | ndarray[_AnyShape, dtype[Any]]:
...
@xp_capabilities(skip_backends=(("jax.numpy", "item assignment"), ("dask.array", "data-dependent output shapes")))
...
_WIN_FUNCS = ...
@xp_capabilities()
def get_window(window, Nx, fftbins=..., *, xp=..., device=...): # -> scipy._lib.array_api_compat.common._typing.Array | tuple[scipy._lib.array_api_compat.common._typing.Array, float] | tuple[scipy._lib.array_api_compat.common._typing.Array, scipy._lib.array_api_compat.common._typing.Array] | tuple[scipy._lib.array_api_compat.numpy._typing.Array | Any, scipy._lib.array_api_compat.numpy._typing.Array | Any] | scipy._lib.array_api_compat.numpy._typing.Array:
