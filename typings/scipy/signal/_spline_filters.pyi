...
def collapse_2d(x, axis): # -> tuple[Any, Any]:
    ...

def symiirorder_nd(func, input, *args, axis=..., **kwargs):
    ...

def qspline2d(signal, lamb=..., precision=...): # -> Any:
    """
...
def cspline2d(signal, lamb=..., precision=...): # -> Any:
    """
