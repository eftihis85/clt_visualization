...
def firwin(numtaps, cutoff, *, width=..., window=..., pass_zero=..., scale=..., fs=...): # -> Any | tuple[scipy._lib.array_api_compat.common._typing.Array | float, ...] | tuple[scipy._lib.array_api_compat.common._typing.Array, ...] | tuple[scipy._lib.array_api_compat.numpy._typing.Array | Any, ...] | NDArray[complexfloating[Any, Any]]:
...
def firwin_2d(hsize, window, *, fc=..., fs=..., circular=..., pass_zero=..., scale=...): # -> NDArray[complex128 | float64] | complex128 | float64 | _Array2D[complex128 | Any]:
    """
