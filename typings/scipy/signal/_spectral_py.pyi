...
def periodogram(x, fs=..., window=..., nfft=..., detrend=..., return_onesided=..., scaling=..., axis=...): # -> tuple[_Array[tuple[()], float64], _Array[tuple[()], float64]] | tuple[_Array[tuple[int], float64] | _Array[tuple[()], float64] | ndarray[_AnyShape, dtype[Any]], ndarray[tuple[int], dtype[float64]] | ndarray[tuple[()], dtype[float64]] | Any]:
    """
...
def welch(x, fs=..., window=..., nperseg=..., noverlap=..., nfft=..., detrend=..., return_onesided=..., scaling=..., axis=..., average=...): # -> tuple[_Array[tuple[int], float64] | _Array[tuple[()], float64] | ndarray[_AnyShape, dtype[Any]], ndarray[tuple[int], dtype[float64]] | ndarray[tuple[()], dtype[float64]] | Any]:
    r"""
...
def csd(x, y, fs=..., window=..., nperseg=..., noverlap=..., nfft=..., detrend=..., return_onesided=..., scaling=..., axis=..., average=...): # -> tuple[_Array[tuple[int], float64], _Array[tuple[int], float64]] | tuple[_Array[tuple[()], float64], _Array[tuple[()], float64]] | tuple[ndarray[_AnyShape, dtype[Any]], Any | ndarray[tuple[()], dtype[Any]] | ndarray[_AnyShape, dtype[Any]]]:
    r"""
...
def istft(Zxx, fs=..., window=..., nperseg=..., noverlap=..., nfft=..., input_onesided=..., boundary=..., time_axis=..., freq_axis=..., scaling=...): # -> tuple[Any, ndarray[_AnyShape, dtype[float64]]]:
...
def coherence(x, y, fs=..., window=..., nperseg=..., noverlap=..., nfft=..., detrend=..., axis=...): # -> tuple[_Array[tuple[int], float64] | _Array[tuple[()], float64] | ndarray[_AnyShape, dtype[Any]], NDArray[float64] | Any]:
    r"""
