...
def argrelmin(data, axis=..., order=..., mode=...): # -> tuple[ndarray[tuple[int], dtype[intp]], ...]:
    """
...
def argrelmax(data, axis=..., order=..., mode=...): # -> tuple[ndarray[tuple[int], dtype[intp]], ...]:
    """
...
def argrelextrema(data, comparator, axis=..., order=..., mode=...): # -> tuple[ndarray[tuple[int], dtype[intp]], ...]:
    """
