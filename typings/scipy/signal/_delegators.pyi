...
def besselap_signature(N, norm=..., *, xp=..., device=...): # -> Any:
    ...

def buttap_signature(N, *, xp=..., device=...): # -> Any:
    ...

def cheb1ap_signature(N, rp, *, xp=..., device=...): # -> Any:
    ...

def cheb2ap_signature(N, rs, *, xp=..., device=...): # -> Any:
    ...

def ellipap_signature(N, rp, rs, *, xp=..., device=...): # -> Any:
    ...
...
def gammatone_signature(freq, ftype, order=..., numtaps=..., fs=..., *, xp=..., device=...): # -> Any:
    ...

def iircomb_signature(w0, Q, ftype=..., fs=..., *, pass_zero=..., xp=..., device=...): # -> Any:
    ...

def iirnotch_signature(w0, Q, fs=..., *, xp=..., device=...): # -> Any:
    ...

iirpeak_signature = ...
def savgol_coeffs_signature(window_length, polyorder, deriv=..., delta=..., pos=..., use=..., *, xp=..., device=...): # -> Any:
    ...

def unit_impulse_signature(shape, idx=..., dtype=...): # -> Any:
    ...

def buttord_signature(wp, ws, gpass, gstop, analog=..., fs=...): # -> ModuleType:
    ...
...
def periodogram_signature(x, fs=..., window=..., *args, **kwds): # -> ModuleType:
    ...
...
def find_peaks_signature(x, height=..., threshold=..., distance=..., prominence=..., width=..., wlen=..., rel_height=..., plateau_size=...): # -> Any:
    ...
...
def freqz_signature(b, a=..., worN=..., *args, **kwds): # -> ModuleType:
    ...
...
def hilbert_signature(x, *args, **kwds): # -> ModuleType:
    ...
