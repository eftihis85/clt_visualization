...
class _csr_base(_cs_matrix):
    ...
    def __iter__(self): # -> Generator[Any | float64 | int_ | numpy.bool[builtins.bool] | ndarray[_AnyShape, dtype[float64 | int_ | numpy.bool[builtins.bool]]] | <subclass of _csr_base* and sparray> | _csr_base, Any, None]:
        ...
